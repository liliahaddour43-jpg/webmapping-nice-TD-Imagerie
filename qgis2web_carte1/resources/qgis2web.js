...
map.getView().fit([795934.449517, 5410805.483759, 817832.712490, 5429945.543962], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Cartographie des isochrones d’accès aux espaces verts à Nice</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (255 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Cette carte illustre l’accessibilité aux espaces verts à Nice selon des temps de déplacement de 5, 10 et 15 minutes. Elle met en évidence les variations spatiales de l’accès à ces espaces et permet d’identifier les zones les mieux et les moins desservies.';
            }
