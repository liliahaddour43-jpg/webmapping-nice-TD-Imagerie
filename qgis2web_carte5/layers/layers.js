...
var format_Carreauxpopulation15minintersectionfortpubliqueespacevert_4 = new ol.format.GeoJSON();
var features_Carreauxpopulation15minintersectionfortpubliqueespacevert_4 = format_Carreauxpopulation15minintersectionfortpubliqueespacevert_4.readFeatures(json_Carreauxpopulation15minintersectionfortpubliqueespacevert_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Carreauxpopulation15minintersectionfortpubliqueespacevert_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Carreauxpopulation15minintersectionfortpubliqueespacevert_4.addFeatures(features_Carreauxpopulation15minintersectionfortpubliqueespacevert_4);
var lyr_Carreauxpopulation15minintersectionfortpubliqueespacevert_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Carreauxpopulation15minintersectionfortpubliqueespacevert_4, 
                style: style_Carreauxpopulation15minintersectionfortpubliqueespacevert_4,
                popuplayertitle: 'Carreaux population-15min-intersection forêt publique -espace vert',
                interactive: true,
                title: '<img src="styles/legend/Carreauxpopulation15minintersectionfortpubliqueespacevert_4.png" /> Carreaux population-15min-intersection forêt publique -espace vert'
            });
var format_Carreauxpopulation10minintersectionfortpubliqueespacevert_5 = new ol.format.GeoJSON();
var features_Carreauxpopulation10minintersectionfortpubliqueespacevert_5 = format_Carreauxpopulation10minintersectionfortpubliqueespacevert_5.readFeatures(json_Carreauxpopulation10minintersectionfortpubliqueespacevert_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Carreauxpopulation10minintersectionfortpubliqueespacevert_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Carreauxpopulation10minintersectionfortpubliqueespacevert_5.addFeatures(features_Carreauxpopulation10minintersectionfortpubliqueespacevert_5);
var lyr_Carreauxpopulation10minintersectionfortpubliqueespacevert_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Carreauxpopulation10minintersectionfortpubliqueespacevert_5, 
                style: style_Carreauxpopulation10minintersectionfortpubliqueespacevert_5,
                popuplayertitle: 'Carreaux population-10min-intersection forêt publique -espace vert',
                interactive: true,
                title: '<img src="styles/legend/Carreauxpopulation10minintersectionfortpubliqueespacevert_5.png" /> Carreaux population-10min-intersection forêt publique -espace vert'
            });

lyr_OpenTopoMap_0.setVisible(false);lyr_OpenStreetMap_1.setVisible(true);lyr_OpenStreetMap_2.setVisible(true);lyr_ContourIRIS_3.setVisible(true);lyr_Carreauxpopulation15minintersectionfortpubliqueespacevert_4.setVisible(true);lyr_Carreauxpopulation10minintersectionfortpubliqueespacevert_5.setVisible(true);
var layersList = [lyr_OpenTopoMap_0,lyr_OpenStreetMap_1,lyr_OpenStreetMap_2,lyr_ContourIRIS_3,lyr_Carreauxpopulation15minintersectionfortpubliqueespacevert_4,lyr_Carreauxpopulation10minintersectionfortpubliqueespacevert_5];
...
lyr_Carreauxpopulation10minintersectionfortpubliqueespacevert_5.on('precompose', function(evt) {
